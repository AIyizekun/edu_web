...
public class AssertsException extends RuntimeException {
    private static final long serialVersionUID = -5704119979301933228L;
     ...
     * @since 1.7
     */
    protected AssertsException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
